...
<html lang="en">
<head>
    <title>Añadir un nuevo vehículo</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="js/newVehicle.js"></script>
</head>
    ...
    <div class="container">
      ...
      <div class="row section">
        <div class="col s12 center-align">
          <span class="flow-text">Si quieres, puedes modificar tu vehículo para añadir algún dato adicional y seguir añadiendo gastos en él</span>
        </div>
      </div>
